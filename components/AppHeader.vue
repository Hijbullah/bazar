<template>
    <header>
        <div class="flex justify-between md:pl-3 bg-orange-300">
            <div class="flex-1">
                <div class="flex items-center">
                    <div class="w-auto md:w-48 flex">
                        ...
                        <h1 class="hidden md:block text-gray-800 text-3xl font-semibold ml-3 mr-6"><a href="#">eBazar</a></h1>
                    </div>
